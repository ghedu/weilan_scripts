...
''''脚本使用说明：
 脚本发布地址 https://pc.fenchuan8.com/#/index?forum=38406
 后缀名改成py
 白嫖的项目：签到白嫖游戏服务器或者稳定的虚拟主机，攒着提现也可以（2018年以来一直稳定运行的，自己可以查一查资料）
 第一步：上传本脚本到青龙（本脚本是py不是js 别搞错了）
 第二步：去   https://www.rainyun.com/MzgwMzM=_  注册一个账号（不提现只抢游戏云和主机的话不用实名）
...
注册地址：
 https://www.rainyun.com/MzgwMzM=_ 
 https://www.rainyun.com/MzgwMzM=_ 
